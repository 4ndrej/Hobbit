...
:woods
if "%1" == "raft" if "%&o5loc%" == "woods" goto rwoods
if "%1" == "south" goto gowoods
if "%1" == "west" goto gowoods
...
goto fail
:wrivendell
if not "%&o2loc%"=="me" goto goclearing
echo Just as you leave, Elrond grabs your lunch. He looks annoyed.
set &o2loc=rivendell
goto goclearing
:nrivendell
if not "%&o2loc%"=="me" goto nrivcont
echo Just as you leave, Elrond grabs your lunch. He looks annoyed.
set &o2loc=rivendell
:nrivcont
if "%&o3loc%" == "me" goto gowodfromriv
...
:gohome
set &room=home
if not "%&o7loc%"=="me" goto success
echo You go west.
call look
echo.
echo As you enter your home again, Gandalf comes to his feet. He comes forward, as
